...
var request = https.get("https://teamtreehouse.com/" + username + ".json", function (response) {
    ...
    response.on("end", function () {
        ...
        if (response.statusCode === 200) {
            ...
            //will print this error. the usual error message isn't very user-friendy, so http.STATUS_Codes[codehere/e.g.404] accesses the slightly more friendly message ("Not found")
        }
    });
});
